                ...
                <?php while ($item = mysqli_fetch_array($result)): ?>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <a href="#" class="text-center"><img class="card-img-top img-fluid" src="../img/<?php echo htmlspecialchars($item['img'], ENT_QUOTES,'UTF-8'); ?>" style="padding:5px;height: auto;width: auto; max-width: 220px; max-height: 220px;"></a>
